...
class Model {
 ...
 public:
  ...
  void PolishNotation(std::string content); /*!< Функция преобразования в польскую нотацию */
  double BuildGraf(std::string X); /*!< Функция расчета координат точек текущего выражения */
